<template>
  <div class="terms overflow-auto">
    ...
    <p>
      You can contact our Copyright Agent via email at trabelsig37@gmail.com.
    </p>
    ...
    <p>
      ...
      are not owned or controlled by TuniChat.
    </p>
    <p>
      TuniChat has no control over, and assumes no responsibility for the
